# code_webremote.py - Omnibot 5402 Webserver-Fernsteuerung (Phase 1, Archiv)
# CircuitPython 10.x auf Cytron RoboESP32
#
# Das ist die erprobte Handsteuerung aus Phase 1, aufgehoben als Rueckfallebene.
# Der regulaere Betrieb laeuft ab Phase 2 ueber src/code.py (serieller
# Motorknoten, gesteuert vom Companion Computer).
#
# Zum Zurueckfallen aufs Board spielen und als /code.py ablegen:
#   .venv/bin/python tools/upload.py src/code_webremote.py /code.py --run
#
